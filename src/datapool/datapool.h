...
void datapool_set_user_data(struct datapool *pool, void *user_data, size_t user_size);
void datapool_get_user_data(struct datapool *pool, void *user_data, size_t user_size);
